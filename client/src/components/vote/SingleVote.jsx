...
export default function SingleVote() {
  ...
  return (
    ...
    >
      <div className="px-2 pt-md-5 mt-md-0 mt-0 rounded-3 col-12 mx-auto bg-md-dark d-md-flex d-block align-items-center">
        <div
          className="d-flex flex-row mb-md-5 mb-4 vote-header col-12 col-md-6 rounded-3 bg-dark shadow"
          style={{ gap: ".2rem" }}
        >
          <div style={{ flex: 1 }} className="text-center p-2 vote-img">
            <img
