...
export default function Home() {
  ...
  return (
    <div className="home-container col-12 p-md-0 pt-0 px-0" id="home">
      {/* Splash Container */}
            ...
            <div>
              ...
              <div className="us">
                <div className="d-md-flex d-block justify-content-start pt-3 pb-md-4 pb-0 mt-3 ms-md-3 m-0 mission-statement">
                  <p className="text-white text-md-start text-center fw-normal mx-auto mx-md-0 col-12 col-md-11 mt-md-2 p-md-0 p-2 text-shadow2 fs-4">
                    Your ultimate destination for cutting edge game servers!
                    Elevate your gaming experience today!
                  </p>
                </div>
                <div className="d-none d-md-flex justify-content-md-start justify-content-center">
                  <Link
