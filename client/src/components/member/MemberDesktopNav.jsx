...
export default function MemberDesktopNav({ loggedInUser }) {
  const linkClass = (isActive) =>
    `text-decoration-none d-flex flex-column align-items-center mb-4 ${
        ...
        {({ isActive }) => (
          ...
          >
            ...
            >
              ...
              <path
                fill="url(#grad-settings-desktop)"
