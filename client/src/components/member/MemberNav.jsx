        ...
        {({ isActive }) => (
          ...
          >
            {!isMobile && (
              ...
              >
                <defs>
                  <linearGradient id="grad-stats" x1="0" y1="0" x2="1" y2="1">
                    <stop
                      offset="0%"
        ...
        {({ isActive }) => (
          ...
          >
            {!isMobile && (
              ...
              >
                <defs>
                  <linearGradient id="grad-tickets" x1="0" y1="0" x2="1" y2="1">
                    <stop
                      offset="0%"
        ...
        {({ isActive }) => (
          ...
          >
            {!isMobile && (
              ...
              >
                <defs>
                  <linearGradient id="grad-notify" x1="0" y1="0" x2="1" y2="1">
                    <stop
                      offset="0%"
                      stopColor={isActive ? "#a891f0" : "#7b2ff7"}
                    />
        ...
        {({ isActive }) => (
          ...
          >
            {!isMobile && (
              ...
              >
                <defs>
                  <linearGradient id="grad-votes" x1="0" y1="0" x2="1" y2="1">
                    <stop
                      offset="0%"
                      stopColor={isActive ? "#a891f0" : "#7b2ff7"}
                    />
      ...
      >
        {({ isActive }) => (
          ...
          >
            {isMobile ? (
              <i
                className={`bi bi-gear-fill fs-4 ${
                  isActive ? "text-white" : "text-secondary"
                }`}
              ></i>
            ) : (
