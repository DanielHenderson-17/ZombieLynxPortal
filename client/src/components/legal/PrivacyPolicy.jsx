export default function PrivacyPolicy() {
  return (
    <div className="text-white text-start pt-5 px-4">
      ...
      <h2 className="mt-5 text-start">Interpretation and Definitions</h2>
      <h3 className="mt-2">Interpretation</h3>
      <p>
      ...
      <ul className="list-unstyled">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Zombie Lynx Gaming.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Zombie Lynx Gaming, accessible
            from
            <a
              href="https://www.zlg.gg"
      ...
      <h3 className="mt-2">Use of Your Personal Data</h3>
      ...
      <h3 className="mt-2">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-2">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-2">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-2">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="mt-2">Security of Your Personal Data</h3>
      <p>
      ...
      <ul>
        <li>
          <p>By email: zombielynxgaming@gmail.com</p>
        </li>
        <li>
          <p>
