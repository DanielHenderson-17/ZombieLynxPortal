...
export default function TicketDetails({
  ...
  return (
    <div className="col-12 mb-0 position-relative d-flex p-2 rounded-top align-items-center ticket-box shadow">
      {/* Div 1 - Game Image */}
      ...
      {/* Div 3 - Close / Restore */}
      <div className="d-md-flex d-none flex-column justify-content-between align-items-end ms-3 pt-3">
        {ticket.status === "Open" ? (
          <button
