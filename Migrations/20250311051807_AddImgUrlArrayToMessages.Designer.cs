...
namespace ZombieLynxPortalAPI.Migrations
{
    ...
    [Migration("20250311051807_AddImgUrlArrayToMessages")]
    partial class AddImgUrlArrayToMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$eqNF1Y.v3EqxRJM92Koz6ePXtgbB/20vPEcvEup1M9rINordVFie.",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.AdminTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 11, 5, 18, 7, 447, DateTimeKind.Utc).AddTicks(3788)
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Message", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("ImgUrls")
                        .HasColumnType("text[]");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 5, 18, 7, 447, DateTimeKind.Utc).AddTicks(7003),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 5, 28, 7, 447, DateTimeKind.Utc).AddTicks(7276),
                            ImgUrls = new List<string>(),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 5, 38, 7, 447, DateTimeKind.Utc).AddTicks(7293),
                            ImgUrls = new List<string>(),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 11, 5, 18, 7, 447, DateTimeKind.Utc).AddTicks(4588),
                            IsGlobal = true,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 3, 10, 5, 18, 7, 447, DateTimeKind.Utc).AddTicks(5014),
                            IsGlobal = false,
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bug",
                            CreatedAt = new DateTime(2025, 3, 11, 5, 18, 7, 447, DateTimeKind.Utc).AddTicks(1807),
                            Description = "Initial test ticket for the system.",
                            Game = "Ark:SA",
                            Server = "NA-East",
                            Status = "Open",
                            Subject = "Test Ticket",
                            UpdatedAt = new DateTime(2025, 3, 11, 5, 18, 7, 447, DateTimeKind.Utc).AddTicks(1948),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.UserTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserProfileId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 11, 5, 18, 7, 447, DateTimeKind.Utc).AddTicks(3002)
                        });
                });
