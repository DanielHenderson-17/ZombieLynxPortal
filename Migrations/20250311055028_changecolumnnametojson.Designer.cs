...
namespace ZombieLynxPortalAPI.Migrations
{
    ...
    [Migration("20250311055028_changecolumnnametojson")]
    partial class changecolumnnametojson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$MXzFJK3YfrpKDmMQi7AwbOI9nQOnRlZ7Mcjo/AOCw1teoI.Hzx.k6",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.AdminTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 11, 5, 50, 27, 906, DateTimeKind.Utc).AddTicks(1061)
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Message", b =>
                {
                    ...
                    b.Property<List<string>>("ImgUrlsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 5, 50, 27, 906, DateTimeKind.Utc).AddTicks(3073),
                            ImgUrlsJson = new List<string>(),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 6, 0, 27, 906, DateTimeKind.Utc).AddTicks(3225),
                            ImgUrlsJson = new List<string>(),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 6, 10, 27, 906, DateTimeKind.Utc).AddTicks(3238),
                            ImgUrlsJson = new List<string>(),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 11, 5, 50, 27, 906, DateTimeKind.Utc).AddTicks(1554),
                            IsGlobal = true,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 3, 10, 5, 50, 27, 906, DateTimeKind.Utc).AddTicks(1799),
                            IsGlobal = false,
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bug",
                            CreatedAt = new DateTime(2025, 3, 11, 5, 50, 27, 905, DateTimeKind.Utc).AddTicks(9883),
                            Description = "Initial test ticket for the system.",
                            Game = "Ark:SA",
                            Server = "NA-East",
                            Status = "Open",
                            Subject = "Test Ticket",
                            UpdatedAt = new DateTime(2025, 3, 11, 5, 50, 27, 905, DateTimeKind.Utc).AddTicks(9981),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.UserTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserProfileId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 11, 5, 50, 27, 906, DateTimeKind.Utc).AddTicks(580)
                        });
                });
