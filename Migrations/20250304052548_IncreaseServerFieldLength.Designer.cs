...
namespace ZombieLynxPortalAPI.Migrations
{
    ...
    [Migration("20250304052548_IncreaseServerFieldLength")]
    partial class IncreaseServerFieldLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$p4D8cvc2.bqroT0p91kffeZUhQ2Jyuv3X.hRmSMUrjFzZnbyCcykq",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.AdminTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 4, 5, 25, 48, 340, DateTimeKind.Utc).AddTicks(6700)
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 4, 5, 25, 48, 341, DateTimeKind.Utc).AddTicks(102),
                            MessageGroupId = 1,
                            UserProfileId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 4, 5, 35, 48, 341, DateTimeKind.Utc).AddTicks(363),
                            MessageGroupId = 1,
                            UserProfileId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 4, 5, 45, 48, 341, DateTimeKind.Utc).AddTicks(418),
                            MessageGroupId = 1,
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 4, 5, 25, 48, 340, DateTimeKind.Utc).AddTicks(7634),
                            IsGlobal = true,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 3, 3, 5, 25, 48, 340, DateTimeKind.Utc).AddTicks(8045),
                            IsGlobal = false,
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bug",
                            CreatedAt = new DateTime(2025, 3, 4, 5, 25, 48, 340, DateTimeKind.Utc).AddTicks(4435),
                            Description = "Initial test ticket for the system.",
                            Game = "Ark:SA",
                            Server = "NA-East",
                            Status = "Open",
                            Subject = "Test Ticket",
                            UpdatedAt = new DateTime(2025, 3, 4, 5, 25, 48, 340, DateTimeKind.Utc).AddTicks(4587),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.UserTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserProfileId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 4, 5, 25, 48, 340, DateTimeKind.Utc).AddTicks(5823)
                        });
                });
