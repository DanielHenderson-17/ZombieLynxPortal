...
namespace ZombieLynxPortalAPI.Migrations
{
    ...
    [Migration("20250311045354_AddDiscordImgUrlToMessages")]
    partial class AddDiscordImgUrlToMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$Pf7iz2zfZA7rZTGCQZmxae8GgMjzDQGBtRRbtWz28oqV4Ok0GJRiC",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.AdminTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 11, 4, 53, 53, 797, DateTimeKind.Utc).AddTicks(2962)
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 4, 53, 53, 797, DateTimeKind.Utc).AddTicks(5008),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 5, 3, 53, 797, DateTimeKind.Utc).AddTicks(5164),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 11, 5, 13, 53, 797, DateTimeKind.Utc).AddTicks(5178),
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 11, 4, 53, 53, 797, DateTimeKind.Utc).AddTicks(3471),
                            IsGlobal = true,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 3, 10, 4, 53, 53, 797, DateTimeKind.Utc).AddTicks(3724),
                            IsGlobal = false,
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bug",
                            CreatedAt = new DateTime(2025, 3, 11, 4, 53, 53, 797, DateTimeKind.Utc).AddTicks(1746),
                            Description = "Initial test ticket for the system.",
                            Game = "Ark:SA",
                            Server = "NA-East",
                            Status = "Open",
                            Subject = "Test Ticket",
                            UpdatedAt = new DateTime(2025, 3, 11, 4, 53, 53, 797, DateTimeKind.Utc).AddTicks(1831),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.UserTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserProfileId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 11, 4, 53, 53, 797, DateTimeKind.Utc).AddTicks(2454)
                        });
                });
