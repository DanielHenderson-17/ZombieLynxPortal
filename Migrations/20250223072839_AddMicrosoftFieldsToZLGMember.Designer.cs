...
namespace ZombieLynxPortalAPI.Migrations
{
    ...
    [Migration("20250223072839_AddMicrosoftFieldsToZLGMember")]
    partial class AddMicrosoftFieldsToZLGMember
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$jZ3hVeCYokY/2jDuZkbQ.u0OaBnhkn1DuvBhgiTVNcksZhv/.3nzi",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.AdminTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 2, 23, 7, 28, 38, 689, DateTimeKind.Utc).AddTicks(6165)
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 23, 7, 28, 38, 689, DateTimeKind.Utc).AddTicks(8070),
                            MessageGroupId = 1,
                            UserProfileId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 23, 7, 38, 38, 689, DateTimeKind.Utc).AddTicks(8224),
                            MessageGroupId = 1,
                            UserProfileId = 1
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 23, 7, 48, 38, 689, DateTimeKind.Utc).AddTicks(8234),
                            MessageGroupId = 1,
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 2, 23, 7, 28, 38, 689, DateTimeKind.Utc).AddTicks(6676),
                            IsGlobal = true,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 2, 22, 7, 28, 38, 689, DateTimeKind.Utc).AddTicks(6929),
                            IsGlobal = false,
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bug",
                            CreatedAt = new DateTime(2025, 2, 23, 7, 28, 38, 689, DateTimeKind.Utc).AddTicks(4970),
                            Description = "Initial test ticket for the system.",
                            Game = "Ark:SA",
                            Server = "NA-East",
                            Status = "Open",
                            Subject = "Test Ticket",
                            UpdatedAt = new DateTime(2025, 2, 23, 7, 28, 38, 689, DateTimeKind.Utc).AddTicks(5055),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.UserTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserProfileId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 2, 23, 7, 28, 38, 689, DateTimeKind.Utc).AddTicks(5675)
                        });
                });
