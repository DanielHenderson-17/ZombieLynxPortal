...
namespace ZombieLynxPortalAPI.Migrations
{
    ...
    [Migration("20250320042703_MakeUserProfileNullable")]
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$r5G2mUmlKL9S.NwX53GmuebylfspsBl/1PG7kTOEHtFEb3HU7hd1O",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.AdminTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 20, 4, 27, 3, 311, DateTimeKind.Utc).AddTicks(99)
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 20, 4, 27, 3, 311, DateTimeKind.Utc).AddTicks(2010),
                            ImgUrlsJson = "[]",
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 20, 4, 37, 3, 311, DateTimeKind.Utc).AddTicks(2226),
                            ImgUrlsJson = "[]",
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 3, 20, 4, 47, 3, 311, DateTimeKind.Utc).AddTicks(2251),
                            ImgUrlsJson = "[]",
                            MessageGroupId = 1,
                            SentToDiscord = false,
                            UserProfileId = 1
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 20, 4, 27, 3, 311, DateTimeKind.Utc).AddTicks(595),
                            IsGlobal = true,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 3, 19, 4, 27, 3, 311, DateTimeKind.Utc).AddTicks(840),
                            IsGlobal = false,
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bug",
                            CreatedAt = new DateTime(2025, 3, 20, 4, 27, 3, 310, DateTimeKind.Utc).AddTicks(8925),
                            Description = "Initial test ticket for the system.",
                            Game = "Ark:SA",
                            Server = "NA-East",
                            Status = "Open",
                            Subject = "Test Ticket",
                            UpdatedAt = new DateTime(2025, 3, 20, 4, 27, 3, 310, DateTimeKind.Utc).AddTicks(9011),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("ZombieLynxPortalAPI.Models.UserTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserProfileId = 1,
                            TicketId = 1,
                            AssignedAt = new DateTime(2025, 3, 20, 4, 27, 3, 310, DateTimeKind.Utc).AddTicks(9624)
                        });
                });
